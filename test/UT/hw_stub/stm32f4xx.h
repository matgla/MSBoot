...
typedef struct
{
   uint32_t FLTCR1;         /*!< DFSDM control register1,                          Address offset: 0x100 */
   uint32_t FLTCR2;         /*!< DFSDM control register2,                          Address offset: 0x104 */
   uint32_t FLTISR;         /*!< DFSDM interrupt and status register,              Address offset: 0x108 */
   uint32_t FLTICR;         /*!< DFSDM interrupt flag clear register,              Address offset: 0x10C */
   uint32_t FLTJCHGR;       /*!< DFSDM injected channel group selection register,  Address offset: 0x110 */
   uint32_t FLTFCR;         /*!< DFSDM filter control register,                    Address offset: 0x114 */
   uint32_t FLTJDATAR;      /*!< DFSDM data register for injected group,           Address offset: 0x118 */
   uint32_t FLTRDATAR;      /*!< DFSDM data register for regular group,            Address offset: 0x11C */
   uint32_t FLTAWHTR;       /*!< DFSDM analog watchdog high threshold register,    Address offset: 0x120 */
   uint32_t FLTAWLTR;       /*!< DFSDM analog watchdog low threshold register,     Address offset: 0x124 */
   uint32_t FLTAWSR;        /*!< DFSDM analog watchdog status register             Address offset: 0x128 */
   uint32_t FLTAWCFR;       /*!< DFSDM analog watchdog clear flag register         Address offset: 0x12C */
   uint32_t FLTEXMAX;       /*!< DFSDM extreme detector maximum register,          Address offset: 0x130 */
   uint32_t FLTEXMIN;       /*!< DFSDM extreme detector minimum register           Address offset: 0x134 */
...
typedef struct
{
   uint32_t CHCFGR1;     /*!< DFSDM channel configuration register1,            Address offset: 0x00 */
   uint32_t CHCFGR2;     /*!< DFSDM channel configuration register2,            Address offset: 0x04 */
   uint32_t CHAWSCDR;    /*!< DFSDM channel analog watchdog and
                                  short circuit detector register,                  Address offset: 0x08 */
   uint32_t CHWDATAR;    /*!< DFSDM channel watchdog filter data register,      Address offset: 0x0C */
   uint32_t CHDATINR;    /*!< DFSDM channel data input register,                Address offset: 0x10 */
...
typedef struct
{
   uint32_t VR;             /*!< DSI Host Version Register,                                 Address offset: 0x00       */
   uint32_t CR;             /*!< DSI Host Control Register,                                 Address offset: 0x04       */
   uint32_t CCR;            /*!< DSI HOST Clock Control Register,                           Address offset: 0x08       */
   uint32_t LVCIDR;         /*!< DSI Host LTDC VCID Register,                               Address offset: 0x0C       */
   uint32_t LCOLCR;         /*!< DSI Host LTDC Color Coding Register,                       Address offset: 0x10       */
   uint32_t LPCR;           /*!< DSI Host LTDC Polarity Configuration Register,             Address offset: 0x14       */
   uint32_t LPMCR;          /*!< DSI Host Low-Power Mode Configuration Register,            Address offset: 0x18       */
  uint32_t      RESERVED0[4];   /*!< Reserved, 0x1C - 0x2B                                                                 */
   uint32_t PCR;            /*!< DSI Host Protocol Configuration Register,                  Address offset: 0x2C       */
   uint32_t GVCIDR;         /*!< DSI Host Generic VCID Register,                            Address offset: 0x30       */
   uint32_t MCR;            /*!< DSI Host Mode Configuration Register,                      Address offset: 0x34       */
   uint32_t VMCR;           /*!< DSI Host Video Mode Configuration Register,                Address offset: 0x38       */
   uint32_t VPCR;           /*!< DSI Host Video Packet Configuration Register,              Address offset: 0x3C       */
   uint32_t VCCR;           /*!< DSI Host Video Chunks Configuration Register,              Address offset: 0x40       */
   uint32_t VNPCR;          /*!< DSI Host Video Null Packet Configuration Register,         Address offset: 0x44       */
   uint32_t VHSACR;         /*!< DSI Host Video HSA Configuration Register,                 Address offset: 0x48       */
   uint32_t VHBPCR;         /*!< DSI Host Video HBP Configuration Register,                 Address offset: 0x4C       */
   uint32_t VLCR;           /*!< DSI Host Video Line Configuration Register,                Address offset: 0x50       */
   uint32_t VVSACR;         /*!< DSI Host Video VSA Configuration Register,                 Address offset: 0x54       */
   uint32_t VVBPCR;         /*!< DSI Host Video VBP Configuration Register,                 Address offset: 0x58       */
   uint32_t VVFPCR;         /*!< DSI Host Video VFP Configuration Register,                 Address offset: 0x5C       */
   uint32_t VVACR;          /*!< DSI Host Video VA Configuration Register,                  Address offset: 0x60       */
   uint32_t LCCR;           /*!< DSI Host LTDC Command Configuration Register,              Address offset: 0x64       */
   uint32_t CMCR;           /*!< DSI Host Command Mode Configuration Register,              Address offset: 0x68       */
   uint32_t GHCR;           /*!< DSI Host Generic Header Configuration Register,            Address offset: 0x6C       */
   ...
   uint32_t TCCR[6];        /*!< DSI Host Timeout Counter Configuration Register,           Address offset: 0x78-0x8F  */
   uint32_t TDCR;           /*!< DSI Host 3D Configuration Register,                        Address offset: 0x90       */
   uint32_t CLCR;           /*!< DSI Host Clock Lane Configuration Register,                Address offset: 0x94       */
   uint32_t CLTCR;          /*!< DSI Host Clock Lane Timer Configuration Register,          Address offset: 0x98       */
   uint32_t DLTCR;          /*!< DSI Host Data Lane Timer Configuration Register,           Address offset: 0x9C       */
   uint32_t PCTLR;          /*!< DSI Host PHY Control Register,                             Address offset: 0xA0       */
   uint32_t PCONFR;         /*!< DSI Host PHY Configuration Register,                       Address offset: 0xA4       */
   uint32_t PUCR;           /*!< DSI Host PHY ULPS Control Register,                        Address offset: 0xA8       */
   uint32_t PTTCR;          /*!< DSI Host PHY TX Triggers Configuration Register,           Address offset: 0xAC       */
   uint32_t PSR;            /*!< DSI Host PHY Status Register,                              Address offset: 0xB0       */
  uint32_t      RESERVED1[2];   /*!< Reserved, 0xB4 - 0xBB                                                                 */
   uint32_t ISR[2];         /*!< DSI Host Interrupt & Status Register,                      Address offset: 0xBC-0xC3  */
   uint32_t IER[2];         /*!< DSI Host Interrupt Enable Register,                        Address offset: 0xC4-0xCB  */
  uint32_t      RESERVED2[3];   /*!< Reserved, 0xD0 - 0xD7                                                                 */
   uint32_t FIR[2];         /*!< DSI Host Force Interrupt Register,                         Address offset: 0xD8-0xDF  */
  ...
  uint32_t      RESERVED4[2];   /*!< Reserved, 0x104 - 0x10B                                                               */
   uint32_t LCVCIDR;        /*!< DSI Host LTDC Current VCID Register,                       Address offset: 0x10C      */
   uint32_t LCCCR;          /*!< DSI Host LTDC Current Color Coding Register,               Address offset: 0x110      */
  uint32_t      RESERVED5;      /*!< Reserved, 0x114                                                                       */
   uint32_t LPMCCR;         /*!< DSI Host Low-power Mode Current Configuration Register,    Address offset: 0x118      */
  uint32_t      RESERVED6[7];   /*!< Reserved, 0x11C - 0x137                                                               */
   uint32_t VMCCR;          /*!< DSI Host Video Mode Current Configuration Register,        Address offset: 0x138      */
   uint32_t VPCCR;          /*!< DSI Host Video Packet Current Configuration Register,      Address offset: 0x13C      */
   uint32_t VCCCR;          /*!< DSI Host Video Chuncks Current Configuration Register,     Address offset: 0x140      */
   uint32_t VNPCCR;         /*!< DSI Host Video Null Packet Current Configuration Register, Address offset: 0x144      */
   uint32_t VHSACCR;        /*!< DSI Host Video HSA Current Configuration Register,         Address offset: 0x148      */
   uint32_t VHBPCCR;        /*!< DSI Host Video HBP Current Configuration Register,         Address offset: 0x14C      */
   uint32_t VLCCR;          /*!< DSI Host Video Line Current Configuration Register,        Address offset: 0x150      */
   uint32_t VVSACCR;        /*!< DSI Host Video VSA Current Configuration Register,         Address offset: 0x154      */
   uint32_t VVBPCCR;        /*!< DSI Host Video VBP Current Configuration Register,         Address offset: 0x158      */
   uint32_t VVFPCCR;        /*!< DSI Host Video VFP Current Configuration Register,         Address offset: 0x15C      */
   uint32_t VVACCR;         /*!< DSI Host Video VA Current Configuration Register,          Address offset: 0x160      */
  uint32_t      RESERVED7[11];  /*!< Reserved, 0x164 - 0x18F                                                               */
   uint32_t TDCCR;          /*!< DSI Host 3D Current Configuration Register,                Address offset: 0x190      */
  uint32_t      RESERVED8[155]; /*!< Reserved, 0x194 - 0x3FF                                                               */
   uint32_t WCFGR;          /*!< DSI Wrapper Configuration Register,                       Address offset: 0x400       */
   uint32_t WCR;            /*!< DSI Wrapper Control Register,                             Address offset: 0x404       */
   uint32_t WIER;           /*!< DSI Wrapper Interrupt Enable Register,                    Address offset: 0x408       */
   uint32_t WISR;           /*!< DSI Wrapper Interrupt and Status Register,                Address offset: 0x40C       */
   uint32_t WIFCR;          /*!< DSI Wrapper Interrupt Flag Clear Register,                Address offset: 0x410       */
  uint32_t      RESERVED9;      /*!< Reserved, 0x414                                                                       */
   uint32_t WPCR[5];        /*!< DSI Wrapper PHY Configuration Register,                   Address offset: 0x418-0x42B */
  uint32_t      RESERVED10;     /*!< Reserved, 0x42C                                                                       */
   uint32_t WRPCR;          /*!< DSI Wrapper Regulator and PLL Control Register, Address offset: 0x430                 */
} DSI_TypeDef;
#endif /* STM32F469_479xx */
...
#if defined(STM32F413_423xx)
   uint32_t MCHDLYCR;     /*!< SYSCFG multi-channel delay register,               Address offset: 0x30      */
#endif /* STM32F413_423xx */
} SYSCFG_TypeDef;
...
typedef struct
{
   uint32_t CR1;      /*!< FMPI2C Control register 1,            Address offset: 0x00 */
   uint32_t CR2;      /*!< FMPI2C Control register 2,            Address offset: 0x04 */
   uint32_t OAR1;     /*!< FMPI2C Own address 1 register,        Address offset: 0x08 */
   uint32_t OAR2;     /*!< FMPI2C Own address 2 register,        Address offset: 0x0C */
   uint32_t TIMINGR;  /*!< FMPI2C Timing register,               Address offset: 0x10 */
   uint32_t TIMEOUTR; /*!< FMPI2C Timeout register,              Address offset: 0x14 */
   uint32_t ISR;      /*!< FMPI2C Interrupt and status register, Address offset: 0x18 */
   uint32_t ICR;      /*!< FMPI2C Interrupt clear register,      Address offset: 0x1C */
   uint32_t PECR;     /*!< FMPI2C PEC register,                  Address offset: 0x20 */
   uint32_t RXDR;     /*!< FMPI2C Receive data register,         Address offset: 0x24 */
   uint32_t TXDR;     /*!< FMPI2C Transmit data register,        Address offset: 0x28 */
}FMPI2C_TypeDef;
...
typedef struct
{
   ...
   uint16_t   IMR;          /*!< Interrupt mask register,            Address offset: 0x04 */
  uint16_t        RESERVED0;    /*!< Reserved,  0x06                                          */
   uint32_t   SR;           /*!< Status register,                    Address offset: 0x08 */
   uint16_t   IFCR;         /*!< Interrupt Flag Clear register,      Address offset: 0x0C */
  uint16_t        RESERVED1;    /*!< Reserved,  0x0E                                          */
   uint32_t   DR;           /*!< Data input register,                Address offset: 0x10 */
   uint32_t   CSR;          /*!< Channel Status register,            Address offset: 0x14 */
...
typedef struct
{
   uint32_t CR;       /*!< QUADSPI Control register,                           Address offset: 0x00 */
   uint32_t DCR;      /*!< QUADSPI Device Configuration register,              Address offset: 0x04 */
   uint32_t SR;       /*!< QUADSPI Status register,                            Address offset: 0x08 */
   uint32_t FCR;      /*!< QUADSPI Flag Clear register,                        Address offset: 0x0C */
   uint32_t DLR;      /*!< QUADSPI Data Length register,                       Address offset: 0x10 */
   uint32_t CCR;      /*!< QUADSPI Communication Configuration register,       Address offset: 0x14 */
   uint32_t AR;       /*!< QUADSPI Address register,                           Address offset: 0x18 */
   uint32_t ABR;      /*!< QUADSPI Alternate Bytes register,                   Address offset: 0x1C */
   uint32_t DR;       /*!< QUADSPI Data register,                              Address offset: 0x20 */
   uint32_t PSMKR;    /*!< QUADSPI Polling Status Mask register,               Address offset: 0x24 */
   uint32_t PSMAR;    /*!< QUADSPI Polling Status Match register,              Address offset: 0x28 */
   uint32_t PIR;      /*!< QUADSPI Polling Interval register,                  Address offset: 0x2C */
   uint32_t LPTR;     /*!< QUADSPI Low Power Timeout register,                 Address offset: 0x30 */
} QUADSPI_TypeDef;
